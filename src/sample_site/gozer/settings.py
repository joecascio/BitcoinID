# Django settings for gozer project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gozer.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&amp;4h1^m8znfl0q13w6fw9pgox5&amp;m8odld5_f)%c!1f8)posunv='
...
ROOT_URLCONF = 'gozer.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'gozer.wsgi.application'
